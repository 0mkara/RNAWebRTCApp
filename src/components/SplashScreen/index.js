...
import { Text, View, TextInput, AsyncStorage, Modal, Alert, TouchableOpacity } from 'react-native';
            ...
            <View style={{ alignItems: 'center', flex: 1 }}>
              ...
              <View style={{ position: 'absolute', bottom: 0 }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                  <Button style={commonStyle.buttonStyle} title="Login" onPress={() => this.goLogin()}>
                    <Text style={commonStyle.buttonTextStyle}>Login</Text>
                  </Button>
                  <Button style={commonStyle.buttonStyle} title="Signup" onPress={() => this.goSignup()}>
