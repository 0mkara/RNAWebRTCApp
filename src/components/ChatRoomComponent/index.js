...
class ChatRoom extends Component {
    ...
    onPressExchange(socketId) {
        this.props.navigation.navigate('ChatScreen', {socketId: socketId, username: this.props.username});
    }
    handleSend() {
        const messages = this.state.messages;
...
const mapStateToProps = ({ connection, routes }) => {
	...
	return { connected, socketids, message, datachan_stat, room_joined, username, routes };
};
