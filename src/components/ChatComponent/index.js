...
import { CREATE_OFFER, SEND_MESSAGE , SETUSER, GETUSER} from '../../actions/types';
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <View style={{paddingTop: 25, backgroundColor: 'aliceblue', paddingHorizontal: 10, flex: 1, width: '100%'}}>
                    <LinearGradient
                    ...
                    style={styles.headerStyle}>
                        <View style={{backgroundColor: 'transparent', flex: 1, flexDirection: 'row', justifyContent: 'center'}}>
                            ...
                            <View style={{flex: 1, justifyContent: 'center'}}>
                                ...
                                <Text style={{color: '#fff'}}>{this.props.username ? this.props.username : state.params.socketId}</Text>
                            </View>
...
const mapStateToProps = ({ connection, nav }) => {
    const { routes, index } = nav;
    const { connected, socketids, message, datachan_stat, room_joined, username } = connection;
	return { connected, socketids, message, datachan_stat, room_joined, username, routes, index };
};
